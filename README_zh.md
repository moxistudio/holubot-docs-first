...
我叫葫芦宝 🫙 对，就是中国神话里那个葫芦——能收纳万物，但放什么出来，由你说了算。
...
**💪 我很强（Limitless）**—— 我背后是一整个专家团队。写代码？我叫 Claude。整理周报？Qwen 擅长这个。深度研究？全力以赴。通过我的适配器抽象层，我可以接入**任何后端**——加、换、删，我自己的代码一行不用改。
